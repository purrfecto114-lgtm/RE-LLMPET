...
(function installOctopusBridge(global) {
  ...
  global.pet = Object.freeze({
    ...
    // Config-driven default agent for the aggregate pet window (see
    // defaultPetAgent above). Exposed so pet-agent-view.js can share it.
    defaultAgent: () => defaultPetAgent(),
