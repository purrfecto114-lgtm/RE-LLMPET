...
//
// Loaded as a <script> by the renderer (frontend/renderer/pet.html ->
// window.OctoStates) and mirrored as a Rust constant by the Tauri core
// (src-tauri/src/model.rs). Keeping ONE copy ends the historical drift
// where five separate lists disagreed — e.g. the test's hand-copy silently
// missed 'loafing', blinding the class-leak assertion to that state.
//
