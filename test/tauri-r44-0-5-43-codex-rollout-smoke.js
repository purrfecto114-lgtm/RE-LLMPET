...
// R44 0.5.52: Codex rollout watcher + parity matrix verification.
//
// Verifies:
...
assert.strictEqual(packageJson.version, '0.5.52',
  '0.5.52: package.json version must be 0.5.52');
...
assert.ok(codexRolloutItem.implementedIn === '0.5.46',
  '3: Codex rollout watcher must be marked implementedIn 0.5.46 (historical: feature shipped in 0.5.46) (historical: feature shipped in 0.5.52)');
...
assert.ok(changelog.includes('0.5.52'),
  'CHANGELOG must have 0.5.52 entry');

console.log('✓ R44 0.5.52 Codex rollout + parity matrix smoke: all assertions passed');
