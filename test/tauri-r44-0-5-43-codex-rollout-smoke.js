...
// R44 0.5.50: Codex rollout watcher + parity matrix verification.
//
// Verifies:
...
assert.ok(codexRolloutItem.implementedIn === '0.5.46',
  '3: Codex rollout watcher must be marked implementedIn 0.5.46 (historical: feature shipped in 0.5.46) (historical: feature shipped in 0.5.50)');
...
console.log('✓ R44 0.5.50 Codex rollout + parity matrix smoke: all assertions passed');
