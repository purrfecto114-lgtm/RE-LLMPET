...
//   - a human-readable identifier like 'octopus-0.5.41' (for local dev)
...
assert.strictEqual(manifest.root, `Octopus-0.5.41`,
  `P0-5: manifest.root must be Octopus-0.5.41 (got ${manifest.root})`);
