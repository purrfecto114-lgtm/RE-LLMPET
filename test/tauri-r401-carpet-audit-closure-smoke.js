...
// R40.1 (2026-08-01) — 0.5.57 carpet audit closure smoke.
//
...
assert(changelog.includes('0.5.57'),
  'P0-5: CHANGELOG must have 0.5.57 entry');
assert(changelog.includes('0.5.57'),
...
//   - a human-readable identifier like 'octopus-0.5.57' (for local dev)
...
assert.strictEqual(manifest.version, '0.5.57',
...
assert.strictEqual(manifest.root, `Octopus-0.5.57`,
  `P0-5: manifest.root must be Octopus-0.5.57 (got ${manifest.root})`);
