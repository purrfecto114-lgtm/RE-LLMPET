...
// R40.1 (2026-08-01) — 0.5.54 carpet audit closure smoke.
//
...
assert(changelog.includes('0.5.54'),
  'P0-5: CHANGELOG must have 0.5.54 entry');
assert(changelog.includes('0.5.54'),
...
//   - a human-readable identifier like 'octopus-0.5.54' (for local dev)
...
assert.strictEqual(manifest.version, '0.5.54',
  'P0-5: manifest version must be 0.5.54');
...
assert.strictEqual(manifest.root, `Octopus-0.5.54`,
  `P0-5: manifest.root must be Octopus-0.5.54 (got ${manifest.root})`);
