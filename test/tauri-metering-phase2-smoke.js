...
assert.strictEqual(pkg.version, '0.5.49', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.5.49', 'Tauri version must match phase4');
assert.match(cargo, /version = "0.5.49"/, 'Rust package version must match phase4');
