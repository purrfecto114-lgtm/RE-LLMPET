...
assert.strictEqual(pkg.version, '0.5.56', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.5.56', 'Tauri version must match phase4');
assert.match(cargo, /version = "0.5.56"/, 'Rust package version must match phase4');
