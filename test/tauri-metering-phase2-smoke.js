...
assert.strictEqual(pkg.version, '0.5.6', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.5.6', 'Tauri version must match phase4');
assert.match(cargo, /version = "0\.5\.6"/, 'Rust package version must match phase4');
