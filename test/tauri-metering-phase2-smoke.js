...
assert.strictEqual(pkg.version, '0.5.0', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.5.0', 'Tauri version must match phase4');
assert.match(cargo, /version = "0\.5\.0"/, 'Rust package version must match phase4');
