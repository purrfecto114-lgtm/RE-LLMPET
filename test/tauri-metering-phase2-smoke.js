...
assert.strictEqual(pkg.version, '0.6.3', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.6.3', 'Tauri version must match phase4');
assert.match(cargo, /version = "0.6.3"/, 'Rust package version must match phase4');
