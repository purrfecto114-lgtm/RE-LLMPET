...
assert.strictEqual(pkg.version, '0.6.5', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.6.5', 'Tauri version must match phase4');
assert.match(cargo, /version = "0.6.5"/, 'Rust package version must match phase4');
