...
assert.strictEqual(pkg.version, '0.5.61', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.5.61', 'Tauri version must match phase4');
assert.match(cargo, /version = "0.5.61"/, 'Rust package version must match phase4');
