...
assert.strictEqual(pkg.version, '0.6.2', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.6.2', 'Tauri version must match phase4');
assert.match(cargo, /version = "0.6.2"/, 'Rust package version must match phase4');
