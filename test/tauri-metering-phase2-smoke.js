...
assert.strictEqual(pkg.version, '0.5.53', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.5.53', 'Tauri version must match phase4');
assert.match(cargo, /version = "0.5.53"/, 'Rust package version must match phase4');
