...
assert.strictEqual(pkg.version, '0.5.30', 'package version must match phase4');
assert.strictEqual(tauri.version, '0.5.30', 'Tauri version must match phase4');
assert.match(cargo, /version = "0\.5\.30"/, 'Rust package version must match phase4');
