...
assert.strictEqual(pkg.version, '0.5.47');
assert.strictEqual(tauri.version, '0.5.47');
assert.match(cargo, /version = "0.5.47"/);
...
// R44 0.5.47: use cloned runtime Arc instead of state.runtime (borrow fix)
