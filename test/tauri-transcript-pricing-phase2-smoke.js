...
assert.strictEqual(pkg.version, '0.5.50');
assert.strictEqual(tauri.version, '0.5.50');
assert.match(cargo, /version = "0.5.50"/);
...
// R44 0.5.50: use cloned runtime Arc instead of state.runtime (borrow fix)
