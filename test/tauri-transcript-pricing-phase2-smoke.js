...
assert.strictEqual(pkg.version, '0.5.52');
assert.strictEqual(tauri.version, '0.5.52');
assert.match(cargo, /version = "0.5.52"/);
...
// R44 0.5.52: use cloned runtime Arc instead of state.runtime (borrow fix)
