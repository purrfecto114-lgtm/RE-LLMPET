...
assert.strictEqual(pkg.version, '0.5.56');
assert.strictEqual(tauri.version, '0.5.56');
assert.match(cargo, /version = "0.5.56"/);
...
// R44 0.5.56: use cloned runtime Arc instead of state.runtime (borrow fix)
