...
assert.strictEqual(pkg.version, '0.5.54');
assert.strictEqual(tauri.version, '0.5.54');
assert.match(cargo, /version = "0.5.54"/);
...
// R44 0.5.54: use cloned runtime Arc instead of state.runtime (borrow fix)
