...
assert.strictEqual(pkg.version, '0.5.48');
assert.strictEqual(tauri.version, '0.5.48');
assert.match(cargo, /version = "0.5.48"/);
...
// R44 0.5.48: use cloned runtime Arc instead of state.runtime (borrow fix)
