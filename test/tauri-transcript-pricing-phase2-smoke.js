...
assert.strictEqual(pkg.version, '0.5.57');
assert.strictEqual(tauri.version, '0.5.57');
assert.match(cargo, /version = "0.5.57"/);
...
// R44 0.5.57: use cloned runtime Arc instead of state.runtime (borrow fix)
