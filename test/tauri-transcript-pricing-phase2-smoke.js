...
assert.strictEqual(pkg.version, '0.5.53');
assert.strictEqual(tauri.version, '0.5.53');
assert.match(cargo, /version = "0.5.53"/);
...
// R44 0.5.53: use cloned runtime Arc instead of state.runtime (borrow fix)
