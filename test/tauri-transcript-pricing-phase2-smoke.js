...
assert.strictEqual(pkg.version, '0.5.44');
assert.strictEqual(tauri.version, '0.5.44');
assert.match(cargo, /version = "0.5.44"/);
...
// R44 0.5.44: use cloned runtime Arc instead of state.runtime (borrow fix)
