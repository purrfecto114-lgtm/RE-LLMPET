...
assert.strictEqual(pkg.version, '0.5.49');
assert.strictEqual(tauri.version, '0.5.49');
assert.match(cargo, /version = "0.5.49"/);
...
// R44 0.5.49: use cloned runtime Arc instead of state.runtime (borrow fix)
