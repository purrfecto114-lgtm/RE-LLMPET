...
assert.strictEqual(pkg.version, '0.5.43');
assert.strictEqual(tauri.version, '0.5.43');
assert.match(cargo, /version = "0.5.43"/);
...
// R44 0.5.43: use cloned runtime Arc instead of state.runtime (borrow fix)
