...
// R44 Phase 0C (2026-08-03) — 0.5.57 unified backup + install receipt smoke.
//
...
assert.ok(cargoToml.includes('version = "0.5.57"'),
  'P0C: Cargo.toml version must be 0.5.57');
assert.strictEqual(tauriConf.version, '0.5.57',
...
console.log('✓ R44 Phase 0C (0.5.57) backup + receipt smoke: all assertions passed');
