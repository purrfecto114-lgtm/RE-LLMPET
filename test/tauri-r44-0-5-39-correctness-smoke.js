...
// R44 0.5.40 (roadmap v5) — correctness closure smoke.
//
// Locks the 7 deliverables from roadmap v5 §0.5.40:
//
...
assert.strictEqual(packageJson.version, '0.5.40',
  '0.5.40: package.json version must be 0.5.40');
...
// R44 0.5.40: signature changed to Result<ResetResult, String> (transactional)
assert.ok(
...
assert.ok(changelog.includes('0.5.40'),
  'CHANGELOG must have 0.5.40 entry');

console.log('✓ R44 0.5.40 (roadmap v5) correctness closure smoke: all assertions passed');
