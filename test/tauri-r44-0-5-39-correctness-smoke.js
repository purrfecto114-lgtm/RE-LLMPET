...
// R44 0.5.39 (roadmap v5) — correctness closure smoke.
//
// Locks the 7 deliverables from roadmap v5 §0.5.39:
//
...
assert.strictEqual(packageJson.version, '0.5.39',
  '0.5.39: package.json version must be 0.5.39');
...
assert.ok(model.includes('pub fn backup_and_reset_config(&self) -> Result<PathBuf, String>'),
...
assert.ok(changelog.includes('0.5.39'),
  'CHANGELOG must have 0.5.39 entry');

console.log('✓ R44 0.5.39 (roadmap v5) correctness closure smoke: all assertions passed');
