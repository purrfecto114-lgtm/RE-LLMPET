...
assert.strictEqual(packageJson.version, '0.5.49',
  'R40: package.json version must be 0.5.49');
...
// R40.1/R44-0.5.49: strip_legacy_codewhale_hooks was DELETED in 0.5.49
...
// R40.1 but kept as dead code; 0.5.49 removes it entirely.
assert(!hookInstall.includes('fn strip_legacy_codewhale_hooks'),
  'R44-0.5.49: strip_legacy_codewhale_hooks must be DELETED (roadmap v5 §6 — dangerous dead code)');
assert(!hookInstall.includes('fn parse_toml_string_value'),
  'R44-0.5.49: parse_toml_string_value must be DELETED (only used by deleted strip_legacy_codewhale_hooks)');
