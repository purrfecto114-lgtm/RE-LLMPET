...
const checks = [
  ...
  ['Rust diagnostic command no longer accepts cwd', (commands.includes('pub fn diagnose_agent(provider: String)') || commands.includes('pub async fn diagnose_agent(provider: String)') || commands.includes('pub async fn diagnose_agent(\n    app: AppHandle,\n    provider: String,') || commands.includes('pub async fn diagnose_agent(\n    provider: String,\n    state: State') || commands.includes('pub async fn diagnose_agent(provider: String, state: State')) && commands.includes('agent_working_directory(None)')],
