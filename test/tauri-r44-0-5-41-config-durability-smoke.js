...
// R44 0.5.57 — Config durability + receipt-driven uninstall + idempotent sync.
//
...
console.log('✓ R44 0.5.57 config durability + receipt-driven uninstall smoke: all assertions passed');
