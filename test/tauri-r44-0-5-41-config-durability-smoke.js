...
// R44 0.5.45 — Config durability + receipt-driven uninstall + idempotent sync.
//
...
console.log('✓ R44 0.5.45 config durability + receipt-driven uninstall smoke: all assertions passed');
