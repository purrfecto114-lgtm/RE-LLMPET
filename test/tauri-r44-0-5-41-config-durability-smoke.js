...
// R44 0.5.44 — Config durability + receipt-driven uninstall + idempotent sync.
//
...
console.log('✓ R44 0.5.44 config durability + receipt-driven uninstall smoke: all assertions passed');
