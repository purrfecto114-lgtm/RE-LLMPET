...
// R44 0.5.43 — Config durability + receipt-driven uninstall + idempotent sync.
//
...
assert.ok(model.includes('pub const CURRENT_SCHEMA_VERSION: u32 = 1'),
...
console.log('✓ R44 0.5.43 config durability + receipt-driven uninstall smoke: all assertions passed');
