...
// R44 0.5.46 — Config durability + receipt-driven uninstall + idempotent sync.
//
...
console.log('✓ R44 0.5.46 config durability + receipt-driven uninstall smoke: all assertions passed');
