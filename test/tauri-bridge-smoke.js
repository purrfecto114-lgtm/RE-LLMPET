...
const expected = [
  ...
  'getConfig', 'getStats', 'getPriceInfo', 'getTravel', 'refreshModelPrices', 'setPriceAutoUpdate', 'rebuildUsageCosts', 'setLanguage', 'openPanel', 'closePanel', 'setMode', 'setPetMode', 'setSkin',
