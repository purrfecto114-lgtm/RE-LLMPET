...
>
> 盯着 **Claude Code / CodeWhale / Codex / OpenCode / dsh** 五个 coding agent，随状态变表情、弹消息气泡、一键授权，并统计 token 用量与花费。本地优先、MIT。
...
- **五 provider 适配**：Claude Code、CodeWhale、Codex、OpenCode、dsh 的 provider-specific 安装与事件适配
